...
function TaskDetailContent() {
  ...
  return (
    <>
      ...
      <div
        onClick={handleClose}
        className="fixed inset-0 bg-slate-950/40 backdrop-blur-sm z-40 animate-fade-in"
      />

      {/* Slide-Over Drawer / Panel */}
      <div className="fixed inset-y-0 right-0 w-full max-w-2xl bg-white dark:bg-slate-900 border-l border-slate-200 dark:border-slate-800 shadow-2xl z-50 overflow-y-auto p-4 sm:p-8 space-y-6 animate-slide-in-right">
        {/* Header Bar with Go Back */}
        <div className="flex items-center justify-between pb-4 border-b border-slate-200/80 dark:border-slate-800">
          <button
            onClick={handleClose}
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-bold transition-all active:scale-95"
          >
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row items-stretch gap-6">
              ...
              <div className="w-full md:w-1/2 space-y-4 flex flex-col justify-between">
                ...
                <button
                  ...
                  className={`w-full py-2.5 px-4 rounded-2xl text-xs font-extrabold shadow-md transition-all flex items-center justify-center gap-2 ${
                    currentTask.is_completed
            ...
            <div className="pt-6 border-t border-slate-200/80 dark:border-slate-800 flex items-center justify-end gap-3">
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-indigo-600 dark:text-indigo-400 text-xs font-bold transition-all flex items-center gap-1.5"
              >
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-rose-500/10 hover:bg-rose-500/20 text-rose-600 dark:text-rose-400 border border-rose-500/20 text-xs font-bold transition-all flex items-center gap-1.5"
              >
