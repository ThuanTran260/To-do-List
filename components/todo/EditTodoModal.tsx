          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
            ...
            <div className="space-y-1">
              ...
              <button
                ...
                className="w-full bg-slate-50 dark:bg-slate-800 p-2.5 rounded-xl border border-slate-200 dark:border-slate-700 text-xs font-semibold text-slate-900 dark:text-slate-100 hover:border-indigo-500 focus:outline-none flex items-center justify-between transition-colors cursor-pointer"
              >
